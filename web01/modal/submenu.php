...
<form action="./api/submenu.php" method='post' enctype="multipart/form-data">
    ...
    <div style="display:flex;margin:auto;width:70%">
        ...
        <div style="width:45%;margin:5px 0.5%">
            <input type="text" name="href[]" style="width:95%" value="<?=$row['href'];?>">
        </div>
        <div style="width:10%;margin:5px 0.5%">
            <input type="checkbox" style="width:95%" name="del[]" value="<?=$row['id'];?>">
        </div>
...
function more() {
    let item = `
            <div style="display:flex;margin:auto;width:70%">
                <div style="width:45%;margin:5px 0.5%">
                    <input type="text" name="text2[]" style="width:95%">
                </div>
                <div style="width:45%;margin:5px 0.5%">
                    <input type="text" name="href2[]" style="width:95%">
                </div>
                <div style="width:10%;margin:5px 0.5%">
