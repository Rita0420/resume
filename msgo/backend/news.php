...
?>
    <div class="boxC mt-2">
        ...
        <div class="gameC" style="width: 40%;">
            <div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">新增最新消息輪播圖</h4>
                ...
                <div class="modal-body">
                    ...
                    <label for="newPic">新增最新消息輪播圖片</label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" data-bs-dismiss="modal">新增</button>
